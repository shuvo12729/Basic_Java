...
public class Program_4 {
    public static void main(String[] args) {
        ...
        3. If user inputs more than balance, then system should throw an error message as "Not enough balance. Please input valid amount" and takes the valid input again---------------------5

*/
        int PIN = 1234;
        double balance = 100000;
        System.out.println("Type any option 1 or 2");
